...
/*   Updated: 2025/02/25 16:08:51 by joaomart         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
char	*gnl_ft_strjoin(char *left_str, char *buff)
{
	...
	if (!left_str || !buff)
		return (NULL);
	str = malloc(sizeof(char) * ((gnl_ft_strlen(left_str) + gnl_ft_strlen(buff)) + 1));
	if (str == NULL)
		return (NULL);
	i = -1;
	j = 0;
...
char	*ft_new_left_str(char *left_str)
{
	...
	str = (char *)malloc(sizeof(char) * (gnl_ft_strlen(left_str) - i + 1));
	if (!str)
		return (NULL);
	i++;
	j = 0;
