...
#    Updated: 2025/03/11 21:43:23 by joaomart         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SO_LONG_SRCS = srcs/so_long.c srcs/args_checker.c srcs/error.c srcs/validate_map.c \
				...
				srcs/game_imgs.c srcs/img_animation.c srcs/load_imgs.c srcs/destroy_mlx.c \
				srcs/free.c srcs/moves.c srcs/validate_game.c
